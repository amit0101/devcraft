...
const features = [
  {
    ...
    description: 'Build intelligent applications tailored to your business needs with cutting-edge AI technology.',
    icon: (
  ...
  },
  {
    ...
    description: 'Scale your business with robust enterprise-grade AI solutions designed for growth.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: 'Create powerful mobile experiences with AI capabilities for iOS and Android platforms.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            >
              We craft intelligent applications that drive innovation and growth. Our expertise in AI
              integration helps businesses stay ahead in the digital age.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            We offer a full range of AI development services to help you build smarter, more efficient
            applications.
          </p>
        </div>
